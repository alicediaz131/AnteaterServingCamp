...
function putClothesOn()
{
    ...
    {
        case 1:
            top = "url('photos/top1.png'), ";
            break;
        case 2:
            top = "url('photos/top2.png'), ";
            break;
        case 3:
            top = "url('photos/top3.png'), ";
        default: 
            break;
    }
    ...
    {
        case 1:
            bottom = "url('photos/bottom1.png'), ";
            break;
        case 2:
            bottom = "url('photos/bottom2.png'), ";
            break;
        case 3:
            bottom = "url('photos/bottom3.png'), ";
        default: 
            break;
    }
    ...
    {
        case 1:
            shoes = "url('photos/shoes1.png'), ";
            break;
        case 2:
            shoes = "url('photos/shoes2.png'), ";
            break;
        case 3:
            shoes = "url('photos/shoes3.png'), ";
        default: 
            break;
    }
    ...
    switch(backgroundInt) {
        ...
        case 1:
            backgroundStr = "url('photos/anteaterBase.png'), url('images/campfire.jpg');";
            break;
        case 2:
            backgroundStr = "url('photos/anteaterBase.png'), url('images/campsite.jpg');";
            break;
        case 3:
            backgroundStr = "url('photos/anteaterBase.png');";
            break;
        default:
            backgroundStr = "url('photos/anteaterBase.png'); ";
    }
